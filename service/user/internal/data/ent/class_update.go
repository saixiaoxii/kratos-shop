...
func (cu *ClassUpdate) SetLevel(i int) *ClassUpdate {
...
func (cu *ClassUpdate) SetNillableLevel(i *int) *ClassUpdate {
	if i != nil {
		cu.SetLevel(*i)
	}
	return cu
...
func (cu *ClassUpdate) AddLevel(i int) *ClassUpdate {
...
func (cu *ClassUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.AddedLevel(); ok {
		_spec.AddField(class.FieldLevel, field.TypeInt, value)
	}
...
// SetLevel sets the "level" field.
func (cuo *ClassUpdateOne) SetLevel(i int) *ClassUpdateOne {
...
// SetNillableLevel sets the "level" field if the given value is not nil.
func (cuo *ClassUpdateOne) SetNillableLevel(i *int) *ClassUpdateOne {
	if i != nil {
		cuo.SetLevel(*i)
	}
	return cuo
...
// AddLevel adds i to the "level" field.
func (cuo *ClassUpdateOne) AddLevel(i int) *ClassUpdateOne {
