...
type UserClient interface {
	...
	CheckPassword(ctx context.Context, in *PasswordCheckInfo, opts ...grpc.CallOption) (*CheckReply, error)
}
...
func (c *userClient) CheckPassword(ctx context.Context, in *PasswordCheckInfo, opts ...grpc.CallOption) (*CheckReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckReply)
...
type UserServer interface {
	...
	CheckPassword(context.Context, *PasswordCheckInfo) (*CheckReply, error)
...
func (UnimplementedUserServer) CheckPassword(context.Context, *PasswordCheckInfo) (*CheckReply, error) {
